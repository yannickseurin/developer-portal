...
The following sections detail how those permissions are granted. It is crucial to uphold the principle of least priviledge: each application must use permissions only absolutely necessary to its execution.
...
First, we recommend the first level in this hierarchy of subkeys be always tied to a "purpose" as described in [BIP-0043](https://github.com/bitcoin/bips/blob/master/bip-0043.mediawiki).
